...
func TestMsgpackExtensions(t *testing.T) {
	...
	//}
	// Fix was copied from gammazero/nexus v3 branch without the breaking API changes for v3.
	// See https://github.com/gammazero/nexus/commit/dfbb28c68debdc66e4a63f8759307998830e9f15
}
